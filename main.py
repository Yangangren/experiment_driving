...
def built_parser():
    ...
    parser.add_argument('--load_dir', type=str, default='./utils/models/{}/experiment-2021-01-04-01-24-07'.format(task))
    ...
    parser.add_argument('--backup', type=str, default='RELA_POLICY: modify_model_parameters_CLIP TORQUE TO 250: ADD inertia(0.2)')
