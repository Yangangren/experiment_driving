...
def controller_agent(shared_list, receive_index, if_save, if_radar,
                     lock, task, case, noise_factor, load_dir, load_ite, result_dir, inertia_time):
...
def built_parser():
    ...
    parser.add_argument('--inertia_time', type=float, default=1.)
...
def main():
    ...
    procs.append(Process(target=controller_agent, args=(shared_list, receive_index, args.if_save, args.if_radar, lock,
                                                        ...
                                                        args.load_ite, args.result_dir,args.inertia_time)))
